...
// Leaflet touches `window` at module-evaluation time, so a static
// import bundles it into the server chunk and crashes on prerender.
// Loading it dynamically with ssr:false keeps it client-only.
